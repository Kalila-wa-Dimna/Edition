  ...
  // initialize CATview
  CATview.initialize();
  CATview.names = toc_catview_data.names;
  CATview.edges = toc_catview_data.edges;
  CATview.extra_segments = toc_catview_data.extra_segments;
  CATview.set_edge_names(toc_catview_data.edge_names);
